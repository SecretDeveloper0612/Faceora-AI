...
export function SleepScheduleInputScreen({ onContinue }: { onContinue?: (time: string) => void }) {
  ...
  // Progress Bar
  const progressWidth = useSharedValue(70);
  ...
  useEffect(() => {
    ...
    progressWidth.value = withDelay(300, withTiming(77, { duration: 1000, easing: Easing.out(Easing.exp) }));
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <Animated.View style={[styles.contentSection, contentStyle]}>
          <Text style={styles.headline}>What time do you usually sleep?</Text>
          <Text style={styles.subheadline}>Consistent sleep schedules optimize overnight skin regeneration.</Text>
